...
use App\Http\Controllers\Student_mail_verification\EmailVerificationNotificationController;
use App\Http\Controllers\Student_mail_verification\VerifyEmailController;
use App\Http\Controllers\Student_mail_verification\EmailVerificationPromptController;
...
Route::middleware(['auth'])->controller(CompanyController::class)->group(function () {
    ...
    Route::post('/company-store', 'store')->name('company.profile');
    // Route::get('/admin/profile', 'profile')->name('admin.profile');
    // Route::get('/edite/profile', 'Editeprofile')->name('edite.profile');
    // Route::post('/store/profile', 'StoreProfile')->name('store.profile');
...
Route::middleware(['auth'])->controller(StatusController::class)->group(function () {
    ...
    Route::post('/status-store', 'store')->name('store.status');
