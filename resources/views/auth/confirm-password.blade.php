            ...
            <div class="container-fluid p-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="text-muted text-center font-size-18"><b>Password Verify</b></h4>
                        <div class="alert alert-warning">This is a secure area of the application. Please confirm your password before continuing.</div>
                        <div class="p-3">
