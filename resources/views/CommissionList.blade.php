                                               ...
                                               @php $i=1  @endphp
                                                @foreach ($payments as $row)
                                                    <tr>
                                                        ...
                                                        <a  onclick="return confirm('Are you sure to delete the commission payment record permanently ?')"  href="{{ route('delete.commission',$row->id) }}" role="button"><i class="las la-trash font-25"></i></a>
                                                        </td>
