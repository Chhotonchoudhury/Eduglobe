                                        ...
                                        <div class="tab-content" id="lineTabContent-3">
                                            ...
                                            <div class="tab-pane fade @if(!$errors->any()) show active @endif" id="underline-about" role="tabpanel" aria-labelledby="underline-about-tab">
                                                ...
                                                <div class="row ml-3 mr-3 mb-1 mt-0 p-1 bg-light" style="border-left: 5px solid #f3a129">
                                                    <div class="col-md-6">
                                                    <p class="mb-0" style="font-size: 15px;margin-top: 8px;font-family: sans-serif;font-weight: bold;color:#2262c6">All Application Status</p>
                                                    </div>
                                                ...
                                                <table id="list"  class="table table-bordered table-hover" style="width: 100%;">
                                                  <thead style="background-color: #f2f2f2;">
                                                    ...
                                                    @foreach ($status as $row)
                                                        ...
                                                        <td>{{$row->user->name }}</td>
                                                        <td class="d-flex">
                                                        <a   href="{{ route('edite.status',$row->id) }}" role="button"><i class="las la-edit font-25"></i></a>
                                                        <a class="delete-confirm" data-id="{{ route('delete.status',$row->id) }}" href="#"><i class="las la-trash font-25 text-danger"></i></a>
                                            ...
                                            <div class="tab-pane fade @if($errors->any()) show active @endif" id="underline-project" role="tabpanel" aria-labelledby="underline-project-tab">
                                                <!--start content-->
                                                <form  method="POST" action="{{ route('store.status') }}" enctype="multipart/form-data">
                                            @csrf
