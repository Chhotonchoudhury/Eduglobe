                                                  ...
                                                  <div class="from-control col-md-4">
                                                         <lable>Select University</lable>
                                                          <select class="form-control" name="university" required=""> 
                                                            ...
                                                            <option value="{{ $un->id }}" @if($un->id == $course->university_id) selected @endif>{{ $un->name }}</option>
                                                            @endforeach  
                                                          </select>
                                                  
                                                     @error('university')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="parsley-required">{{ $message }}</li></ul>@enderror
                                                  </div>
