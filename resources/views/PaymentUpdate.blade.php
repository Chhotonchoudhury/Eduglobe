       ...
       @if(Auth::user()->can('university-student-payment-update'))
                        <form  method="POST" action="{{ route('update.payment') }}" enctype="multipart/form-data">
                          ...
                          <div class="from-control row col-md-12">
                                    ...
                                    <select class="form-control" name="course" id="uni_degree"> 
                                    ...
                                    <select class="form-control student" name="student" id="student_up" > 
                                ...
                                <div class="from-control row col-md-12"><div></div></div>
        ...
        @else
          <span class="badge badge-danger font-15">&#129488; &nbsp;&nbsp;You can't update of payments .....</span>
        @endif                            
                ...
                $.ajax({
                    ...
                    success:function(response) {
                        ...
                        $.each(response.data, function($key , item){
                            $('#student_up').append('<option value="'+item.id+'" '+( item.id == student ? 'selected' : '' )+'>'+ item.name +'</option>');
                        });
                    }
                });
            }else{
