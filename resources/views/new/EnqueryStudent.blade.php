...
<body>
                  ...
                  <div style="margin-bottom: 0px; padding: 10px; padding-right: 20px;" class="querytabslead">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td width="10%" align="left" valign="top"><a href="{{ route('enq.stu', 2) }}">
                        ...
                        <td width="10%" align="left" valign="top"><a href="{{ route('enq.stu', 3) }}">
                        ...
                        <td width="10%" align="left" valign="top"><a href="{{ route('enq.stu', 4) }}">

                            <div class="statusbox" style="background-color:#cc00a9;">
                              <div style="margin-bottom: 0px; font-size: 30px; line-height: 38px;">
                                <div @if($idFromUrl==4)class="ripple" @endif></div> {{ count($referstu) }}

                              </div><span class="badge badge-secondary">Refered</span>
                            </div>
                          </a></td>

                        <td width="10%" align="left" valign="top"><a href="{{ route('enq.stu', 5) }}">
                            ...
                            <div class="statusbox" style="background-color:#46cd93;">
                              ...
                              </div><span class="badge badge-secondary">Course accepted</span>
                            </div>
                          </a></td>


                        <td width="10%" align="left" valign="top"><a href="{{ route('enq.stu', 6) }}">

                            <div class="statusbox" style="background-color:#FF6600;">

                              <div style="margin-bottom: 0px; font-size: 30px; line-height: 38px;">
                                <div @if($idFromUrl==6)class="ripple" @endif></div> {{ count($prostu) }}
                              </div><span class="badge badge-orange">Processed</span>
                            </div>
                          </a></td>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td width="3%" align="left" valign="top" style="padding-right:10px;"><input
                                  type="checkbox" name="assignall[]" class="checkBoxClass" id="assignqury"
                                  value="100008" onclick="selectedfun();" style="width: 16px; height: 16px;"> </td>
                              ...
                              <td width="17%" align="left" valign="top" style="padding-right:20px;">
                                ...
                                @elseif($idFromUrl == 5)
                                <span class="badge badge-success" style="background-color:#46cd93;">Course
                                  accepted</span>
                                @else
                                ...
                                <div
                                  ...
                                  <a href="display.html?ga=query&view=1&id=100008">Age {{ $row->age }}</a>
                                </div>
                              ...
                              <td width="13%" align="right" valign="middle">
                                ...
                                <div class="btn-group" role="group" aria-label="Option">
                                  ...
                                  <a class="admin-vrify-confirm"
                                    data-id="{{ route('verify.stu.enq', [$row->id, Auth::user()->id ] ) }}" href="#">
                                  ...
                                  <a href="{{ route('view.stu',$row->id)  }}"><button type="button"
                            ...
                            <tr>
                              ...
                              <td width="3%" align="center" valign="top" style="padding-right:10px;">
                                <img
                                  ...
                                  width="35" height="35" style="border-radius: 25px;" />
                              </td>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <select class="form-control basic reqfield" id="country" name="country" require>
                      ...
                      <option data-countryCode="1268" value="Antigua &amp; Barbuda">Antigua &amp; Barbuda (+1268)
                      </option>
                      ...
                      <option data-countryCode="236" value="Central African Republic">Central African Republic (+236)
                      </option>
                      ...
                      <option data-countryCode="1868" value="Trinidad &amp; Tobago">Trinidad &amp; Tobago (+1868)
                      </option>
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="groupfields">
                      <tbody>
                        <tr>
                          <td colspan="2"><input type="text" class="form-control" id="code" placeholder="+91"
                              required="" name="pre" value="" style="width:67px !important; margin-right:5px;" readonly>
                          </td>
                          <td><input type="text" class="form-control reqfield" name="mobile"
  ...
  <div class="modelnew modal right fade" id="ADvModal" tabindex="-1" role="dialog" aria-labelledby="ADvModal">
    ...
    <!-- Modal -->
    <div class="modelnew modal right fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
