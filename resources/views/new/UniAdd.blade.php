      ...
      <div class="newhead">University
        <div class="newoptionmenu">
          ...
          <div> <button type="button" class="btn btn-secondary btn-lg waves-effect waves-light"
              onclick="loadpop2('Add Student Group',this,'400px')" data-toggle="modal" data-target="#myModal2"
              data-backdrop="static" popaction="action=addclientgroup">Add University</button>
          </div>
                        ...
                        <tr>
                          ...
                          <td width="1%"><a class="dropdown-item neweditpan"
                              ...
                              data-target=".bs-example-modal-center" popaction="action=addcourse&amp;id=100001"><img
                                src="{{ (!empty($row->logo)) ? asset('uploads/'.$row->logo.''):('https://bootdey.com/img/Content/avatar/avatar7.png') }}"
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input value="{{old('name')}}" name="name" type="text" placeholder="Enter university name"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{old('arabic_name')}}" placeholder="أدخل اسم الجامعة" name="arabic_name"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input value="{{old('campus')}}" name="campus" type="text"
                      placeholder="Enter university campus name" class="form-control" id="campus">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" name="u_number" value="{{old('u_number')}}" placeholder="Enter university number"
                      class="form-control" id="unumber">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{old('email')}}" placeholder="Enter university email"
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="number" name="ex_number" value="{{old('ex_number')}}"
                      placeholder="Enter Executive number" class="form-control" id="ex_number">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="email" name="ex_email" value="{{old('ex_email')}}" placeholder="Enter Executive email"
                      class="form-control" id="ex_email">
