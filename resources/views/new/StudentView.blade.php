...
<html lang="en">
   ...
   <body>
    ...
    <style>
      ...
      .container-fluid label{width: 100% !important; margin-bottom: 2px !important;font-size: 12px; text-transform: uppercase;}
            ...
            <div class="newboxheading">
              <div class="newhead">Query ID: 100004  
                <div class="newoptionmenu">            
                    <div>
                  <a onclick="createquery('100004');" ><button type="button" class="btn btn-secondary btn-lg waves-effect waves-light btn-primary-gray" style="margin-bottom:10px;" >
                  ...
                  <div>
                  <a href="display.html?ga=query&view=1&id=100004&c=3" ><button type="button" class="btn btn-secondary btn-lg waves-effect waves-light btn-primary-gray" style="margin-bottom:10px;" >

                                                      <i class="fa fa-calendar-check-o" aria-hidden="true"></i> &nbsp;Activity</button></a>
                  </div>
                  
                  <div>
                  <a popaction="action=composemail&queryId=100004" onclick="loadpop('Compose Mail',this,'900px')" data-toggle="modal" data-target=".bs-example-modal-center"  ><button type="button" class="btn btn-secondary btn-lg waves-effect waves-light btn-primary-gray" style="margin-bottom:10px;" >

                                                      <i class="fa fa-envelope-o" aria-hidden="true"></i> &nbsp;Email</button></a>
                  </div>
                  
                  <div>
                  <a target="_blank" href="https://api.whatsapp.com/send?text=Hi&phone=+919654907178"  ><button type="button" class="btn btn-secondary btn-lg waves-effect waves-light btn-primary-gray" style="margin-bottom:10px;" >

                                                      <i class="fa fa-whatsapp" aria-hidden="true" style="color:#009900;"></i> &nbsp;Whatsapp</button></a>
                  </div>
                            ...
                            <div class="row" style="margin-right: 0px; margin-left: 0px;">
                              ...
                              <ul class="nav nav-tabs nav-tabs-custom" style="border-bottom:0px solid #dee2e6;">
                                ...
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab"
                                        href="#lead-details-tab"><span class="d-none d-md-block"><i
                                        class="fa fa-id-card-o" aria-hidden="true"></i> &nbsp;Student Details</span><span
                                ...
                                href="#mails-tab"><span class="d-none d-md-block"><i
                                        class="fa fa-envelope-o" aria-hidden="true"></i> &nbsp;Mails</span><span
                                    ...
                                    <div class="col-lg-12" style="padding-left:5px;">
                                     ...
                                     <div class="row mb-2">
                                        ...
                                        <div class="row col-md-2" style="padding-right:0px;">
                                                <img class="user-image" src="{{ (!empty($student->photo)) ? asset('uploads/'.$student->photo.'') : 'https://bootdey.com/img/Content/avatar/avatar7.png' }}"  width="120" height="110" style="border-radius: 3px;border: 2px solid bisque;padding:2px">
                                        </div>
                                     </div>
                                        ...
                                        <div class="row" style="padding-left:10px;  ">
                                          ...
                                          <div class="col-lg-4">
                                            <div class="form-group input-group"
                                              ...
                                              <a href="{{ route('qualification.delete',$row->id) }}"><i class="fa fa-trash " style="position: absolute; top: 5px; right: 5px; color: red; cursor: pointer;"></i></a>
                                          ...
                                          <div class="col-lg-3">
                                            <div class="form-group input-group"
                                              ...
                                              <div
                                                ...
                                                <i class="fa fa-plus" aria-hidden="true"></i> Add Qualification </div>
                                            </div>
                                          </div>
                                       </div>
                                            ...
                                            <div class="col-lg-6">
                                              <div class="form-group input-group"
                                                ...
                                                <tr>
                                                  ...
                                                  <td><strong>&nbsp;:&nbsp;</strong></td>
                                                  <td class="d-flex">@if($student->course_id){{ \Carbon\Carbon::parse($row->course->starting_date)->format('F j, Y') }}  / {{ \Carbon\Carbon::parse($row->course->starting_date2)->format('F j, Y') }}@endif</td>
                                                </tr>
                                                  <tr>
                                        ...
                                        <div class="row" style="padding-left:10px;  ">
                                          ...
                                          <div class="col-lg-4">
                                            <div class="form-group input-group"
                                             ...
                                             <form action="{{ route('remove_course.stu') }}" method="post">
                                              ...
                                              <button type="submit" style="position: absolute; top: 5px; right: 5px; background: none; border: none; color: red; cursor: pointer;">
                                              ...
                                              <table border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                  <td style="font-weight:400 !important; color:#666666;">Starting dates </td>
                                                  <td><strong>&nbsp;:&nbsp;</strong></td>
                                                  <td class="d-flex">{{ \Carbon\Carbon::parse($row->starting_date)->format('F j, Y') }}  / {{ \Carbon\Carbon::parse($row->starting_date2)->format('F j, Y') }}</td>
                                                </tr>
                                          ...
                                          <div class="col-lg-3">
                                            <div class="form-group input-group"
                                              ...
                                              <div
                                                style="text-align: center; width: 100%; padding: 27px; font-size: 16px; cursor: pointer;">
                                                <i class="fa fa-plus" aria-hidden="true"></i> Add Course </div>
                                            </div>
                                          </div>
                                        </div>
                                </div>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form action="{{ route('qualification.stu') }}" method="post" enctype="multipart/form-data" id="qualification">
                                @csrf
                               <input type="hidden" name="id"  value="{{ $student->id }}"> 
                                ...
                                <div style="margin-bottom:2px; font-size:12px;">Qualification</div>  
                                  ...
                                  <select name="qualification" class="form-control" autocomplete="off" style="margin-bottom:10px;" required>   
                                  ...
                                  <div class="form-group" style="overflow:hidden;"> 
                                    <div style="margin-top:5px;">
                                     <button type="submit" id="submit"  class="btn btn-primary"  style="float:right;"><i class="fa fa-plus" aria-hidden="true"></i> Save</button>
                                    </div>
                                  </div>
