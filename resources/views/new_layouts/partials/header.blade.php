<!---new dashboar-->
<link href="{{ asset('new_assets/assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('new_assets/assets/css/icons.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('new_assets/assets/css/style.css?i=1')}}" rel="stylesheet" type="text/css">
<link rel="stylesheet" href="{{ asset('new_assets/plugins/summernote/summernote-bs4.css')}}">
<link rel="stylesheet" href="{{ asset('new_assets/plugins/circlechart/progresscircle.css')}}">
...
<link href="{{ asset('new_assets/customstyle.css?i=1')}}" rel="stylesheet" type="text/css">
{{--
