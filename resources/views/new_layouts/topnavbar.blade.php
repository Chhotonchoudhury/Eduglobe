...
<div id="tograypanelmenu">
  ...
  <div class="logonavitop">
    <a href="https://tripcrm.in/educrm/crm/" class="topmainlogomain"><img
        src="{{ (!empty($cp->logo)) ? asset('uploads/'.$cp->logo):asset('assets/assets/img/logo.png') }}" /></a>
    ...
    <div class="prifilemenuouter" id="clickbox">
      <div class="inside">
        ...
        <div class="content" style="border-bottom:2px solid #2d2f31; text-align:center;">
          <div class="workinghoursstrip" style="background-color: transparent; color: #adadad; padding: 0px;"><i
              class="fa fa-clock-o" aria-hidden="true"></i> Today's Working Hours: <span
              id="showcurrentworkinghours">0</span></div>
        </div>
        <script>
...
$('#showcurrentworkinghours').load('todaysworkinghours.php'); 
        ...
        <div class="content" style="border-bottom:2px solid #2d2f31; text-align:center;">
          ...
          <div style="text-align: left; padding: 0px 5px; line-height: 22px; font-size: 12px; color: #adadad;">Total
            Remaining <strong>11278 Days</strong><br />
      ...
      <div class="content">
        <a href="{{ route('logout') }}">
          <div class="buttonprofile" style="border: 0px; margin: 0px;"><i class="fa fa-sign-out" aria-hidden="true"></i>
            &nbsp; Logout of my account</div>
        </a>
      </div>
  ...
  <div class="rightmenu">
    ...
    <a href="{{ route('settings') }}" title="Setting" style="position:relative; padding-top: 5px; padding-right:0px;"
      data-toggle="tooltip" data-placement="bottom" data-original-title="Setting"><svg
        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="19px" height="19px"
    ...
    <a href="#" title="Notification" style="position:relative; padding-top: 6px;" data-toggle="tooltip"
      data-placement="bottom" data-original-title="Notification" style="position:relative;"
        ...
        <g id="icon-sales-activity" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <g id="icon-group" class="unified360-valignimg" transform="translate(1.000000, 0.000000)" stroke="#000000">
            <g id="Group-25-Copy" transform="translate(0.500000, 0.500000)">
              <path
                d="M8.12797546,0.8125 L10.2916667,0.8125 C10.5908209,0.8125 10.8333333,1.05501243 10.8333333,1.35416667 L10.8333333,12.4583333 C10.8333333,12.7574876 10.5908209,13 10.2916667,13 L0.541666667,13 C0.242512427,13 0,12.7574876 0,12.4583333 L0,1.35416667 C0,1.05501243 0.242512427,0.8125 0.541666667,0.8125 L0.541666667,0.8125 L2.69438171,0.8125"
                id="Rectangle-4"></path>
              <rect id="Rectangle-8" stroke-linecap="round" stroke-linejoin="round" x="2.70833333" y="0"
                width="5.41666667" height="1.625"></rect>
              <path
                d="M1.89583333,5.42914206 L2.52198813,6.04041802 C2.54309154,6.06101997 2.57677825,6.06101997 2.59788166,6.04041802 L3.79166667,4.875"
                id="Path-2" stroke-linecap="round"></path>
              <path
                d="M1.89583333,9.22080872 L2.52198813,9.83208469 C2.54309154,9.85268664 2.57677825,9.85268664 2.59788166,9.83208469 L3.79166667,8.66666667"
                id="Path-2" stroke-linecap="round"></path>
              <line x1="5.81063139" y1="5.28125" x2="8.80208333" y2="5.28125" id="Line-7" stroke-linecap="round"
                stroke-linejoin="round"></line>
              <line x1="5.81063139" y1="9.07291667" x2="8.80208333" y2="9.07291667" id="Line-7" stroke-linecap="round"
                stroke-linejoin="round"></line>
            </g>
          </g>
        </g>
