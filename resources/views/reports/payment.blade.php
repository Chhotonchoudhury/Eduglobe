                                    ...
                                    <div class="align-self-center col-lg-5">
                                        <div class="text-lg-center mt-4 mt-lg-0">
                                            <div class="row">
                                               <div class="col-4">
                                                    <div>
                                                        <p class="text-muted text-truncate mb-2">Payments</p>
                                                        <h5 class="mb-0" id="stu">{{ $payment_total }}</h5>
                                                    </div>
                                                </div>
                                                <div class="col-4">
                                                    <div>
                                ...
                                <table id="list"  class="table table-bordered" style="width: 100%;">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th></th>
                                                            <th></th>
                                                            <th class="text-center"><span class="badge bg-primary font-15">Total :- {{$payment_total}}</span></th>
                                                        </tr>
                                                    </tfoot>
                                    </tbody> </table>
                </div>
