...
<div class="col-xl-12">
<div class="hero-cap">
<h2> @if(session()->get('locale') == 'en') Category @else فئة @endif</h2>
...
<p>choose your best and suitable courses </p>
       ...
       <div class="col-lg-12">
            ...
            <span class="text-danger col-md-12 widget font-45"><h4>" @if(session()->get('locale') == 'en') {{ $cat->name }} @else {{ $cat->name_arabic }} @endif" -  @if(session()->get('locale') == 'en') category related courses @else الدورات ذات الصلة بالفئة @endif   </h4></span>
            </div>
...
@else
<span class="text-danger col-md-12 widget font-45"><h3>@if(session()->get('locale') == 'en') Noting Found ! @else مع ملاحظة وجدت! @endif   </h3></span>
@endif
...
<div class="col-lg-12" >
 ...
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <a href="{{ route('browse.course') }}" class="btn header-btn2">@if(session()->get('locale') == 'en') see all courses @else انظر جميع الدورات @endif</a>
</div>
