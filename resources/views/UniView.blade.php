...
<div class="widget-content widget-content-area">
    <div class="row layout-spacing pt-0">
        ...
        <div class="col-xl-9 col-lg-8 col-md-8">
            ...
            <div class="cover-image-area widget  row">
                <div class="col-md-6 col-xl-6 col-md-6 mb-3">
                    ...
                    <p class="font-15"><i class="las la-clock font-20 text-primary"></i>&nbsp;Created on :
                        {{$unv->created_at}}</p>

                </div>
                <div class="col-md-6 col-xl-6 col-md-6 mb-3">
                    <p><i class="las la-envelope font-20 text-primary"></i>&nbsp; Executive Email :
                        &nbsp;{{$unv->ex_email}}</p>
                    <p class="font-15"><i class="las la-phone-square font-20 text-primary"></i>&nbsp;Executive Phone :
                        {{$unv->ex_number}}</p>

                    <p><i class="las la-map-marker-alt font-20 text-primary"></i>&nbsp; Address :
                        &nbsp;{{$unv->address}}</p>
                </div>
                ...
                <div class="d-flex">
                    <a class="btn btn-outline-primary mr-2" data-toggle="modal"
                        data-target="#exampleModalFullscreenLabel">Add New Degree</a>
                    <!-- Modal -->
                    <div class="modal fade " id="exampleModalFullscreenLabel" tabindex="-1" role="dialog"
                                    ...
                                    <form action="{{ route('store.degree') }}" method="POST"
                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                <input type="text" name="name" value="{{ old('name') }}"
                                                    class="form-control">
                                                @error('name')<ul class="parsley-errors-list filled text-danger"
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                <input type="text" name="course" value="{{ old('course') }}"
                                                    class="form-control">
                                                @error('course')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                <input type="text" name="period" value="{{ old('period') }}"
                                                    class="form-control">
                                                @error('period')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                @error('degree')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="from-control col-md-4">
                                                ...
                                                <input type="text" name="arabic_name" value="{{ old('arabic_name') }}"
                                                    placeholder="الرجاء إدخال اسم الدورة باللغة العربية"
                                                    class="form-control">
                                                @error('arabic_name')<ul class="parsley-errors-list filled"
                                                    id="parsley-id-13" aria-hidden="false">
                                            ...
                                            <div class="from-control col-md-4">
                                                ...
                                                <input type="text" name="arabic_course"
                                                    value="{{ old('arabic_course') }}"
                                                    placeholder="الرجاء إدخال الدورة باللغة العربية"
                                                    class="form-control">
                                                @error('arabic_course')<ul class="parsley-errors-list filled"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="text-danger">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-4">
                                                ...
                                                <input type="text" name="arabic_period"
                                                    value="{{ old('arabic_period') }}"
                                                    placeholder="الرجاء إدخال فترة الدورة باللغة العربية"
                                                    class="form-control">
                                                @error('arabic_period')<ul class="parsley-errors-list filled"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="text-danger">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                @error('category')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-3">
                                                <lable>Fess</lable>
                                                <input type="text" placeholder="$ 500" name="fees"
                                                    value="{{ old('fees') }}" class="form-control">
                                                @error('fees')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                <input type="date" name="start_date" value="{{ old('start_date') }}"
                                                    class="form-control">
                                                @error('start_date')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-3">
                                                ...
                                                <input type="date" name="start_date2" value="{{ old('start_date2') }}"
                                                    class="form-control">
                                                @error('start_date2')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-lg-12 col-sm-12">
                                                ...
                                                @error('details')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="col-lg-12 col-sm-12">
                                                ...
                                                @error('arabic_details')<ul class="parsley-errors-list filled"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="text-danger">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="col-md-12 row">
                                            <div class="from-control col-md-4">
                                                ...
                                                @error('photo')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-8">
                                                ...
                                                <input type="file" name="multi_image[]" id="multiImg_c"
                                                    class="form-control" multiple="">
                                                @error('multi_image')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="from-control col-md-4">
                                                ...
                                                <div class="col-sm-10">
                                                    <img class="rounded " alt="100x100" width="120"
                                                        src="{{ asset('assets/assets/img/NoBg.jpeg') }}"
                                    ...
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <button type="submit"
                                                        class="btn btn-outline-primary form-control waves-effect waves-light float-end">
                                                        Add Course
                                                    </button>
                                                </div>
                                                ...
                                                <div class="col-md-2">
                                                    <button type="button"
                                                        class="btn btn-md btn-outline-dark form-control float-end  waves-effect waves-light"
                    ...
                    <a class="btn btn-outline-success mr-2" data-toggle="modal"
                        data-target="#paymentModalFullscreenLabel">Payment</a>
                    @endif
                    <!-- starting of the modal-->
                    <!-- this modal for payment section ---->
                    <!--  Modal content for the insert data table -->
                    <div class="modal fade bs-example-modal-sm" id="paymentModalFullscreenLabel" tabindex="-1"
                        role="dialog" aria-labelledby="#paymentModalFullscreenLabel" aria-hidden="true"
                        style="display: none;">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="" method="POST" action="{{ route('payment.student') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <!--Form body section-->
                                        <input type="hidden" name="un_id" value="{{ $unv->id  }}">
                                        ...
                                        <div class="from-control row col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @error('type')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @error('course_name')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @error('student')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="row col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" required="" id="amount" name="amount"
                                                    class="form-control">
                                                @error('amount')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @error('pay_slip')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                                <!-- <p id="amount_word" style="padding: 5px;background-color: black;color: gold;font-size: initial;">In Words</p> -->
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="row col-12">
                                        <div class="col-sm-8">
                                            <button type="submit"
                                                class="btn btn-success form-control waves-effect waves-light">
                                                Pay Now<i class="ri-login-circle-fill align-middle ms-2"></i>
                                            </button>
                                        </div>
                                        <div class="col-sm-4">
                                            <button type="button"
                                                class="form-control btn btn-md btn-outline-dark waves-effect waves-light"
                    ...
                    <a class="btn btn-md btn-outline-danger mr-2" data-toggle="modal"
                        data-target="#commissionModalFullscreenLabel">Commission</a>
                    @endif
                    <!--START OF THE COMMISSION PAYMENT MODAL -->
                    <!-- this modal for payment section ---->
                    <!--  Modal content for the insert data table -->
                    <div class="modal fade bs-example-modal-sm" id="commissionModalFullscreenLabel" tabindex="-1"
                        role="dialog" aria-labelledby="#commissionModalFullscreenLabel" aria-hidden="true"
                        style="display: none;">

                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="commissionModalFullscreenLabel">Make a New Commission
                                        Payment</h6>
                                </div>
                                <div class="modal-body">
                                    <form id="" method="POST" action="{{ route('commission.student') }}"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <!--Form body section-->
                                        <input type="hidden" name="un_id" value="{{ $unv->id  }}">
                                        ...
                                        <div class="from-control row col-md-12">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                @error('com_type')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <lable>Select Course</lable>
                                                <select class="form-control" name="com_course" id="com_degree"
                                                    required="">
                                                    <option value="">Select Course</option>
                                                    @foreach($course as $row)
                                                    <option value="{{$row->id}}">{{$row->name}}</option>
                                                ...
                                                @error('com_course')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <lable>Select student</lable>
                                                <select class="form-control com_student" name="com_student"
                                                    id="com_student" required="">
                                                    <option value="">Select student</option>
                                                </select>
                                                @error('com_student')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                        ...
                                        <div class="row col-md-12">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" required="" id="amountc" name="com_amount"
                                                    class="form-control">
                                                @error('com_amount')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <lable>upload pay slip</lable>
                                                <input type="file" id="com_pay_slip" name="com_pay_slip"
                                                    class="form-control">
                                                @error('com_pay_slip')<ul class="parsley-errors-list filled text-danger"
                                                    id="parsley-id-13" aria-hidden="false">
                                                    <li class="">{{ $message }}</li>
                                                </ul>@enderror
                                                <!-- <p id="amount_word" style="padding: 5px;background-color: black;color: gold;font-size: initial;">In Words</p> -->
                                ...
                                <div class="modal-footer">
                                    ...
                                    <div class="row col-12">
                                        <div class="col-sm-8">
                                            <button type="submit"
                                                class="btn btn-danger form-control waves-effect waves-light">
                                                Pay Now<i class="ri-login-circle-fill align-middle ms-2"></i>
                                            </button>
                                        </div>
                                        <div class="col-sm-4">
                    ...
                    <a href="{{ route('edite.uni',$unv->id) }}"><button class="btn btn-dark " data-toggle="modal"
                            data-target="#notify"><i class="las la-edit font-15"></i>&nbsp;Update</button></a>
                </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12">
                ...
                <ul class="nav nav-tabs  mb-3" id="lineTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="underline-home-tab" data-toggle="tab" href="#underline-home"
                            role="tab" aria-controls="underline-home" aria-selected="true">General Information</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " id="underline-about-tab" data-toggle="tab" href="#underline-about"
                            role="tab" aria-controls="underline-project" aria-selected="false">About</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " id="underline-phd-tab" data-toggle="tab" href="#underline-phd" role="tab"
                            aria-controls="underline-project" aria-selected="false">PHD Degrees</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " id="underline-master-tab" data-toggle="tab" href="#underline-master"
                            role="tab" aria-controls="underline-project" aria-selected="false">Master Degrees</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " id="underline-bachelor-tab" data-toggle="tab" href="#underline-bachelor"
                            role="tab" aria-controls="underline-project" aria-selected="false">Bachelor Degrees</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " id="underline-other-tab" data-toggle="tab" href="#underline-other"
                            role="tab" aria-controls="underline-project" aria-selected="false">Other Degrees</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link " id="underline-students-tab" data-toggle="tab" href="#underline-students"
                            role="tab" aria-controls="underline-project" aria-selected="false">Student List</a>
                    </li>
                </ul>
                <div class="tab-content" id="lineTabContent-3">
                    ...
                    <div class="tab-pane fade " id="underline-about" role="tabpanel"
                        ...
                        <div class="company-info-right">
                            <div class="row">
                                <div class="col-md-4">
                                    <p>Total Degrees : <a class="badge badge-primary text-light">{{ $deeg_total }}</a>
                                    </p>
                                    <p>Total Students : <a class="badge badge-primary text-light">{{ $stu_total }}</a>
                                    </p>
                                    <p>Total Courses : <a class="badge badge-primary text-light">{{ $cou_total }}</a>
                                    </p>
                                    <hr>
                                    <p>Total Payment : <a class="badge badge-info text-light">{{ $payment_total }}</a>
                                    </p>
                                    <p>Total Commission Payment : <a class="badge badge-warning text-light">{{
                                            $commission_total }}</a></p>
                                    <p>Total Student Payment : <a class="badge badge-primary text-light">{{
                                            $stupaymet_total}}</a></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade " id="underline-phd" role="tabpanel" aria-labelledby="underline-phd-tab">
                        ...
                        <table id="list1" class="table table-striped table-hover">
                            ...
                            <tbody id="phd_tbl">
                                ...
                                <tr>
                                    <td>{{ $i }}</td>
                                    <td><img class="rounded-circle" alt="200x200" width="300"
                                            src="{{ asset('uploads/'.$row->photo.'') }}" data-holder-rendered="true"
                                            id="updatephoto" style="width:60px;height:60px"></td>
                                    <td>
                                        {{ $row->name }}<br>
                                        {{ $row->course }}
                                    </td>
                                    ...
                                    <td>
                                        <button type="button"
                                            class="view_btn   btn btn-outline-warning btn-rounded waves-effect waves-light"
                                            value="{{ $row->id }}" role="button"><i class=" las la-eye"></i></button>
                                        <a href="{{ route('coure.edite',$row->id) }}" type="button"
                                            class="btn btn-outline-primary btn-rounded waves-effect waves-light "
                                            role="button"><i class="las la-edit"></i></a>
                                        <a data-id="{{ route('course.delete',$row->id) }}" href="#"
                                            class="delete-confirm btn btn-outline-danger btn-rounded waves-effect waves-light"><i
                    ...
                    <!--master tab-->
                    <div class="tab-pane fade " id="underline-master" role="tabpanel"
                        aria-labelledby="underline-master-tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('coure.edite',$row->id) }}" type="button"
                                            ...
                                            role="button"><i class="las la-edit"></i></a>
                                        <a data-id="{{ route('course.delete',$row->id) }}" href="#"
                                            class="delete-confirm2 btn btn-outline-danger btn-rounded waves-effect waves-light"><i
                                                class=" las la-trash"></i></a>
                                    </td>
                                </tr>
                                @php $i++ @endphp
                    ...
                    <!--bacheloer tab-->
                    <div class="tab-pane fade " id="underline-bachelor" role="tabpanel"
                        aria-labelledby="underline-bachelor-tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('coure.edite',$row->id) }}" type="button"
                                            ...
                                            role="button"><i class="las la-edit"></i></a>
                                        <a data-id="{{ route('course.delete',$row->id) }}" href="#"
                                            class="delete-confirm3 btn btn-outline-danger btn-rounded waves-effect waves-light"><i
                                                class=" las la-trash"></i></a>
                                    </td>
                                </tr>
                                @php $i++ @endphp
                    ...
                    <!--other tab-->
                    <div class="tab-pane fade " id="underline-other" role="tabpanel"
                        aria-labelledby="underline-other-tab">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('coure.edite',$row->id) }}" type="button"
                                            ...
                                            role="button"><i class="las la-edit"></i></a>
                                        <a data-id="{{ route('course.delete',$row->id) }}" href="#"
                                            class="delete-confirm4 btn btn-outline-danger btn-rounded waves-effect waves-light"><i
                                                class=" las la-trash"></i></a>
                                    </td>
                                </tr>
                                @php $i++ @endphp
                    ...
                    <!--students tab-->
                    <div class="tab-pane fade " id="underline-students" role="tabpanel"
                        aria-labelledby="underline-students-tab">
            ...
            <div class="modal fade" id="viewModalFullscreenLabel" tabindex="-1" role="dialog"
                aria-labelledby="#updateModalFullscreenLabel" aria-hidden="true" style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                                    <img class="rounded me-2" alt="200x200" width="100%" id="img"
                                ...
                                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                                    <div class="mt-3 mt-xl-0">
                                        ...
                                        <h4 class="mb-3 text-black strong" id="course"></h4>(<a class="strong"
                                            id="ar_course"></a>)
                                        ...
                                        <p class="text-muted" id="detail"></p>
                                        <hr>
                            ...
                            <div class="modal-footer">
                                <div class="row col-12">
                                    ...
                                    <div class="col-sm-8">
                                        <button class="btn form-control" data-dismiss="modal"><i
