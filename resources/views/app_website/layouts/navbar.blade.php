        ...
        <header class="main-header w-100 z-10">
            <nav class="navbar navbar-expand-xl navbar-light sticky-header">
                <div class="container d-flex align-items-center justify-content-lg-between position-relative">
                    <a href="https://edudeve.com/" class="navbar-brand d-flex align-items-center mb-md-0 text-decoration-none">
                        <img src="{{ asset('app_assets/img/logo1.png') }}" alt="logo" width="130px" height="60px" class="img-fluid logo-white" />
                        <img src="{{ asset('app_assets/img/logo1.png') }}" alt="logo" width="130px" height="60px" class="img-fluid logo-color" />
                    </a>
                ...
                ></i>
                    ...
                    <div class="collapse navbar-collapse justify-content-center">
                        <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                            <li><a href="{{ route('app.home') }}" class="nav-link" style="font-size:16px;font-weight:bold;">HOME</a></li>
                            <li><a href="{{ route('app.about') }}" class="nav-link" style="font-size:16px;font-weight:bold;">ABOUT US</a></li>
                            <li><a href="{{ route('app.services') }}" class="nav-link" style="font-size:16px;font-weight:bold;">SERVICES</a></li>
                            <li><a href="{{ route('app.contact') }}" class="nav-link" style="font-size:16px;font-weight:bold;">CONTACT US</a></li>
                    ...
                    <div class="action-btns text-end me-5 me-lg-0 d-none d-md-block d-lg-block">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="{{ route('app.demos') }}" class="btn btn-default" style="font-size:12px;padding:8px; background-image: linear-gradient(to right, #FF3CA9   , #FF0D5D   );color:white">App Demos</a>
                    </div>
                </div>
            </nav>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasWithBackdrop">
                <div class="offcanvas-header d-flex align-items-center mt-4">
                    <a href="index.html" class="d-flex align-items-center mb-md-0 text-decoration-none">
                        <img src="{{ asset('app_assets/img/logo2.png') }}" width="70px" height="50px" alt="logo" class="img-fluid ps-2" />
                    </a>
                ...
                <div class="offcanvas-body">
                    <ul class="nav col-12 col-md-auto justify-content-center main-menu">
                        <li><a href="{{ route('app.home') }}" class="nav-link">HOME</a></li>
                        <li><a href="{{ route('app.about') }}" class="nav-link">ABOUT US</a></li>
                        <li><a href="{{ route('app.contact') }}" class="nav-link">CONTACT US</a></li>
                        <li><a href="{{ route('app.services') }}" class="nav-link">SERVICES</a></li>
                        <li><a href="{{ route('app.demos') }}" class="nav-link">APP DEMO</a></li>
                        <!-- <li class="nav-item dropdown">
