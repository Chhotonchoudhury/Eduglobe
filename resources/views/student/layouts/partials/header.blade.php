...
<!-- <link href="{{ asset('assets/assets/css/loader.css') }}" rel="stylesheet" type="text/css" /> -->
    ...
    <link href="{{ asset('assets/assets/css/dashboard/dashboard_1.css') }}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{ asset('assets/assets/css/elements/tooltip.css') }}" rel="stylesheet" type="text/css" />
    <!-- Page Level Plugin/Style Ends -->
    <link href="{{ asset('assets/assets/css/forms/form-widgets.css') }}" rel="stylesheet" type="text/css">
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/assets/css/ui-elements/alert.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/assets/css/ui-elements/breadcrumbs.css') }}">
    ...
    <link href="{{ asset('assets/assets/css/ui-elements/pagination.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{ asset('assets/assets/css/apps/companies.css') }}" rel="stylesheet" type="text/css"/>
    ...
    <link href="{{ asset('assets/assets/css/pages/profile.css') }}" rel="stylesheet" type="text/css" />


    <link rel="stylesheet" type="text/css" href="{{ asset('assets/plugins/select2/select2.min.css')  }}">
    <link href="{{ asset('assets/assets/css/forms/form-widgets.css') }}" rel="stylesheet" type="text/css">

    <link href="{{ asset('assets/assets/css/basic-ui/custom_counter.css') }}" rel="stylesheet" type="text/css" />
  ...
  <link rel="stylesheet" href="{{ asset('assets/plugins/circlechart/progresscircle.css') }}">
