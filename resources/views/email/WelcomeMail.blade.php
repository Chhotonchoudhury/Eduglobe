                                       ...
                                       <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                                          <tr style="margin: 0 auto;">
                                             <td align="left" valign="top" style="font-size: 20px; font-weight: bold; line-height: 24px;">
                                                <img src="{{ asset('assets/assets/img/student_profile01.jpg') }}" width="106px" height="106px" alt="">
                                             </td>
                                             <td width="40">&nbsp;</td>
                                             <td align="left" style="font-size: 15px; line-height: 24px;">
                                                <div style="line-height: 24px;">
                                                   <span style="font-weight: bold;">Step 1. Update profile :</span><br><a href="{{ route('student_dashboard') }}" target="__blank"> Log into the student dashboard </a> where you can update your profile. If you have already completed that step, then well done! Proceed to the next step .
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr style="margin: 0 auto;">
                                             <td align="left" valign="top" style="font-size: 20px; font-weight: bold; line-height: 24px;">
                                                <img src="{{ asset('assets/assets/img/student_course01.png') }}" width="106px" height="106px" alt="">
                                             </td>
                                             <td width="40">&nbsp;</td>
                                             <td align="left" style="font-size: 15px; line-height: 24px;">
                                                <div style="line-height: 24px;">
                                                   <span style="font-weight: bold;">Step 2. Accept a Course:</span><br>In your dashboard, you can see two types of courses: 1) Trending courses and 2) Suggested courses (if recommended by the administrator). You have to accept any one course depending on your interest and then follow the next step.
                                                </div>
                                             </td>
                                          </tr>
                                          ...
                                          <tr style="margin: 0 auto;">
                                             <td align="left" valign="top" style="font-size: 20px; font-weight: bold; line-height: 24px;">
                                                <img src="{{ asset('assets/assets/img/student_upload01.jpg') }}" width="106px" height="106px" alt="">
                                             </td>
                                             <td width="40">&nbsp;</td>
                                             <td align="left" style="font-size: 15px; line-height: 24px;">
                                                <div style="line-height: 24px;">
                                                   <span style="font-weight: bold;">Step 3. Upload Required Documents:</span><br>After choosing any course, you have to upload the required documents related to the accepted course. Don't worry, they will automatically show up in your dashboard.
                                                </div>
                                             </td>
                                          </tr>
                                          ...
                                          <tr style="margin: 0 auto;">
                                             <td align="left" valign="top" style="font-size: 20px; font-weight: bold; line-height: 24px;">
                                                <img src="{{ asset('assets/assets/img/student_approvel01.jpg') }}" width="106px" height="106px" alt="">
                                             </td>
                                             <td width="40">&nbsp;</td>
                                             <td align="left" style="font-size: 15px; line-height: 24px;">
                                                <div style="line-height: 24px;">
                                                   <span style="font-weight: bold;">Step 4. Wait for Approval:</span> Now, wait for approval. In your dashboard, you can see a progress chart that shows the status of your course acceptance, so you can track the progress of your course approval.
                                                </div>
                                             </td>
                                          </tr>
