...
<div class="card">
  <div class="card-body">
         ...
         @if(!$data->count() > 0)
         <h6>Insert data in Header section</h6><hr>
            <!--form start of the input section -->
                      <form accept-charset="UTF-8"  method="POST" action="{{ route('website.header.store') }}" enctype="multipart/form-data">
                                     @csrf
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     <lable>The first title is in English</lable>
                                                     <textarea class="form-control" placeholder="The first title is in English" name="en_title1">{{ old('en_title1') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="العنوان الأول باللغة العربية" name="ar_title1">{{ old('ar_title1') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="The second title is in English" name="en_title2">{{ old('en_title2') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="العنوان الثاني باللغة العربية" name="ar_title2">{{ old('ar_title2') }}</textarea>
                                                    ...
                                                    <tbody>
                                                      ...
                                                      @foreach ($data as $row)
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a  href="{{ route('website.header.edite',$row->id) }}" role="button"><i class="las la-edit font-25 text-primary"></i></a>
                                                            <a class="delete-confirm" data-id="{{ route('website.header.delete',$row->id) }}" href="#"><i class="las la-trash font-25 text-danger"></i></a>
                                                            </td>
                                                        </tr>
                                                      @endforeach
                                                    </tbody>
