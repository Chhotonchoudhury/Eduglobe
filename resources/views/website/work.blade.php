...
<div class="card">
  <div class="card-body">
         ...
         @if(!$data->count() > 0)
         <h6>Add data How it's work section</h6><hr>
            <!--form start of the input section -->
                      <form accept-charset="UTF-8"  method="POST" action="{{ route('website.work.store') }}" enctype="multipart/form-data">
                                     @csrf
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     <lable>Main description in English</lable>
                                                     <textarea class="form-control" placeholder="Main description in English" name="en_title">{{ old('en_title') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="الوصف الرئيسي باللغة الإنجليزية" name="ar_title">{{ old('ar_title') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="First point in English" name="en_title1">{{ old('en_title1') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="النقطة الأولى باللغة العربية" name="ar_title1">{{ old('ar_title1') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="Bullet 2 in English" name="en_title2">{{ old('en_title2') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="النقطة 2 باللغة العربية (اختياري)" name="ar_title2">{{ old('ar_title2') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="Bullet 2 in English" name="en_title3">{{ old('en_title3') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="النقطة 3 باللغة العربية (اختياري)" name="ar_title3">{{ old('ar_title3') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="Bullet 4 in English" name="en_title4">{{ old('en_title4') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="النقطة 4 باللغة العربية (اختياري)" name="ar_title4">{{ old('ar_title4') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="Bullet 5 in English " name="en_title5">{{ old('en_title5') }}</textarea>
                                                 ...
                                                 <div class="from-control col-md-6">
                                                     ...
                                                     <textarea class="form-control" placeholder="النقطة 5 باللغة العربية (اختياري)" name="ar_title5">{{ old('ar_title5') }}</textarea>
                                            ...
                                            <div class="col-md-12 row"> 
                                                   <div class="from-control col-md-6">
                                                            ...
                                                            <lable>Upload banner for how it work section</lable>  
                                                    ...
                                                    <tbody>
                                                      ...
                                                      @foreach ($data as $row)
                                                        <tr>
                                                            ...
                                                            <td>
                                                            <a  href="{{ route('website.work.edite',$row->id) }}" role="button"><i class="las la-edit font-25 text-primary"></i></a>
                                                            <a class="delete-confirm" data-id="{{ route('website.work.delete',$row->id) }}" href="#"><i class="las la-trash font-25 text-danger"></i></a>
                                                            </td>
                                                        </tr>
                                                      @endforeach
                                                    </tbody>
