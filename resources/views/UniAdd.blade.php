                ...
                <div class="widget-content-area">
                                    <div class="w-100 animated-underline-content">
                                        <ul class="nav nav-tabs  p-0 m-0 " id="lineTab" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link @if(!$errors->any())active @endif " id="underline-about-tab" data-toggle="tab" href="#underline-about" role="tab" aria-controls="underline-about" aria-selected="true">University List</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link @if($errors->any())active @endif" id="underline-project-tab" data-toggle="tab" href="#underline-project" role="tab" aria-controls="underline-project" aria-selected="false">Add new university</a>
                                            </li>
                                        </ul>
                            <div class="tab-content" id="lineTabContent-3">
                               <div class="tab-pane fade @if(!$errors->any()) show active @endif" id="underline-about" role="tabpanel" aria-labelledby="underline-about-tab">
                                        ...
                                        <div class="row ml-3 mr-3 mb-1 mt-0 p-1 bg-light" style="border-left: 5px solid #f3a129">
                                            <div class="col-md-6">
                                              <p class="mb-0" style="font-size: 15px;margin-top: 8px;font-family: sans-serif;font-weight: bold;color:#2262c6">University List</p>
                                            </div>
                                                    ...
                                                    <tbody>
                                                       @php $i=1  @endphp
                                                        @foreach ($unvs as $row)
                                                            <tr>
                                                                <td>{{ $i }}</td>
                                                                <td><a href="{{ route('view.uni',$row->id) }}"><img class="rounded-circle" alt="200x200" width="300" src="{{ asset('uploads/'.$row->logo.'') }}" data-holder-rendered="true"  style="width:40px;height:40px"></a></td>
                                                                <td>{{ $row->Unumber }}</td>
                                                                ...
                                                                <td class="d-flex">
                                                                <a href="{{ route('view.uni',$row->id) }}" role="button"><i class="las la-eye font-25 text-success"></i></a>
                                                                @if(Auth::user()->can('university-update'))
                                                                <a   href="{{ route('edite.uni',$row->id) }}" role="button"><i class="las la-edit font-25 text-primary"></i></a>
                                                                @endif
                                                                @if(Auth::user()->can('university-delete'))
                                                                <a class="delete-confirm" data-id="{{ route('delete.uni',$row->id) }}" href="#"><i class="las la-trash font-25 text-danger"></i></a>
                                    ...
                                    @csrf 
                                                ...
                                                <div class="col-md-12 row">
                                                                <div class="from-control col-md-4">
                                                                    ...
                                                                    <div class="from-control col-md-4">
                                                                        ...
                                                                        <input type="text" value="{{old('arabic_name')}}" placeholder="أدخل اسم الجامعة" name="arabic_name" class="form-control">
                                                                    ...
                                                                    <div class="from-control col-md-4">
                                                                        ...
                                                                        @error('email')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                                    </div>
                                                ...
                                                <div class="col-md-12 row">
                                                                    ...
                                                                    <div class="from-control col-md-4">
                                                                        ...
                                                                        @error('ex_number')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                                    </div>
                                                                    <div class="from-control col-md-4">
                                                                        <lable>Executive Email</lable>
                                                                        <input type="email" name="ex_email" value="{{old('ex_email')}}" class="form-control">
                                                                        @error('ex_email')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                                    </div>

                                                                    <div class="from-control col-md-4">
                                                                        <lable>University Number</lable>
                                                                        <input type="text" name="u_number" value="{{old('u_number')}}" class="form-control">
                                                                        @error('u_number')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                                    </div>
                                              ...
                                              <div class="col-md-12 row">
                                                   ...
                                                   <div class="from-control col-md-6">
                                                        ...
                                                        @error('address')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                    </div>

                                                    <div class="from-control col-md-6">
                                                            <lable>University Description</lable>
                                                        <textarea class="form-control" name="remarks">{{ old('remarks') }}</textarea>
                                                        @error('remarks')<ul class="parsley-errors-list filled" id="parsley-id-13" aria-hidden="false"><li class="text-danger">{{ $message }}</li></ul>@enderror
                                                     </div>
                                              </div><hr>
                                              ...
                                              <div class="col-md-12 row">
                                                ...
                                                <div class="col-md-12 row">
                                                    <div class="from-control col-md-4">
                                                        ...
                                                        <div class="col-sm-10">
                                                        <img class="rounded " alt="100x100" width="120" src="{{ asset('assets/assets/img/NoBg.jpeg') }}" data-holder-rendered="true" id="updatelogo">
                                                        </div>
                                                    </div>
