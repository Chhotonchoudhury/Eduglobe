    ...
    <div class="w-100 animated-underline-content">
        <ul class="nav nav-tabs  mb-0" id="lineTab" role="tablist">
            <li class="nav-item">
                <a class="nav-link  @if(!$errors->any()) active @endif" id="underline-about-tab" data-toggle="tab"
                    href="#underline-about" role="tab" aria-controls="underline-about" aria-selected="true">Student
                    List</a>
            </li>
            <!--<li class="nav-item">-->
            ...
            <!--</li>-->
            <li class="nav-item">
                <a class="nav-link   @if($errors->any()) active @endif" id="underline-student-tab" data-toggle="tab"
                    href="#underline-student" role="tab" aria-controls="underline-about" aria-selected="true">Archive
                    Student</a>
            </li>
        </ul>
        <div class="tab-content" id="lineTabContent-3">
            ...
            <div class="tab-pane fade @if(!$errors->any()) show active @endif" id="underline-about" role="tabpanel"
                    ...
                    <table id="list" class="table table-bordered table-hover" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="{{ route('view.cor',$row->id) }}"><img class="rounded-circle" alt="200x200"
                                            width="300"
                                ...
                                <td>{{$row->email}}</td>
                                <td class="d-flex"><a
                                        href="https://api.whatsapp.com/send?phone={{$row->country_code.$row->phone}}"
                                        target="_blank"><i class="lab la-whatsapp font-20 text-success"></i></a>
                                    <div>+{{$row->country_code}}{{$row->phone}}</div>
                                </td>
                                <td>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('view.stu', $row->id) }}" role="button" class="p-0 m-0"><i
                                            class="las la-eye font-25 text-success"></i></a>

                                    @if(Auth::user()->can('student-update'))
                                    <a href="{{ route('edite.stu',$row->id) }}" role="button" class="p-0 m-0"><i
                                            class="las la-edit font-25 text-primary"></i></a>
                                    @endif

                                    @if(Auth::user()->can('student-delete'))
                                    <a class="delete-confirm" data-id="{{ route('delete.stu', $row->id) }}" href="#"
                                        class="p-0 m-0"><i class="las la-trash font-25 text-danger"></i></a>
                ...
                @else
                <span class="badge badge-danger font-15">&#129488; &nbsp;&nbsp;You can't see the students, Need admin
                    confirmation .....</span>
                @endif
                <!--end content-->
            ...
            <div class="tab-pane fade @if($errors->any()) show active @endif " id="underline-student" role="tabpanel"
                aria-labelledby="underline-student-tab">
                <!--start content--->
                ...
                <div class="row ml-3 mr-3 mb-1 mt-0 p-1 bg-light" style="border-left: 5px solid #f3a129">
                    <div class="col-md-6">
                        <p class="mb-0"
                            style="font-size: 15px;margin-top: 8px;font-family: sans-serif;font-weight: bold;color:#2262c6">
                            Archive Student List</p>
                    </div>
                    <div class="col-md-3"></div>
                    <div class="col-md-3">
                        <input type="text" id="tblSearch1" placeholder="Search data.."
                            class="form-control form-control-sm float-end mt-1" style="height: 35px;">
                    </div>
                </div>
                    ...
                    <table id="list1" class="table table-bordered table-hover" style="width: 100%;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    <a href="{{ route('view.stu', $row->id) }}" role="button"><i
                                            class="las la-eye font-25 text-info"></i></a>&nbsp;&nbsp;
                                    <a class="undo-confirm" href="#" data-id="{{ route('archive.remove', $row->id) }}"
                                        role="button"><i class="las la-undo-alt font-25 text-danger"></i></a>
                                </td>
...
<div id="UndoModal" class="modal fade">
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Do you really want to reomve this student from archive list & transfer to normal student list ? This
