                                               ...
                                               @php $i=1  @endphp
                                                @foreach ($payments as $row)
                                                    <tr>
                                                        ...
                                                        <a  onclick="return confirm('Are you sure to delete this payment record parmanently ?')"  href="{{ route('delete.student_payment',$row->id) }}" role="button"><i class="las la-trash font-25"></i></a>
                                                        </td>
